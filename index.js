...
/**
 * Creates a new session and caches it
 */
async function createNewSession() {
    ...
    // Cache the session ID in memory and settings
...
async function getSessionId() {
    ...
    // Cache is invalid or doesn't exist, create a new session
